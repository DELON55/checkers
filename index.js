...
const req_lobby = require("./req_lobby.js");
const req_plateau = require("./req_plateau.js");
const req_jouer = require("./req_jouer.js");
const req_select = require("./req_select.js");
		...
		switch (pathname) {
			...
			case '/req_identifier':
			 ...
			 case '/req_lobby':
                ...
                break;
			case '/req_plateau':
                req_plateau(req, res, query);
                break;
			case '/req_jouer':
                req_jouer(req, res, query);
                break;
			case '/req_select':
                req_select(req, res, query);
                break;
